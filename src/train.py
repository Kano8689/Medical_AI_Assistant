...
MAX_DISPLAY_SAMPLES = (NUM_CLASSES * 2)
class_img_show = 2
corrupt_count = 0
...
for label, cat_name in enumerate(CATEGORIES):
    ...
    for img_name in os.listdir(folder_path):
        ...
        try:
            ...
            if class_img_cnt < class_img_show:
...
# BLOCK 1
model.add(Conv2D( 32, (3, 3), activation='relu', kernel_regularizer=l2(0.001), input_shape=(IMAGE_SIZE, IMAGE_SIZE, 3)))
