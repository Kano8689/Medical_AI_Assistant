...
# ******************************************************
model = Sequential([
    Conv2D(32, (3, 3), padding="same", activation="relu", kernel_regularizer=l2(L2_REG), input_shape=(IMAGE_SIZE, IMAGE_SIZE, 3)),
    BatchNormalization(),
    ...
    Conv2D(512, (3, 3), padding="same", activation="relu", kernel_regularizer=l2(L2_REG)),
    BatchNormalization(),
    Conv2D(512, (3, 3), padding="same", activation="relu", kernel_regularizer=l2(L2_REG)),
    BatchNormalization(),
    MaxPooling2D((2, 2)),
